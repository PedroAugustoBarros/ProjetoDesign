...
//            super.onBackPressed();
            if (frameLayoutFrag.getVisibility() == View.VISIBLE) {
                frameLayoutFrag.setVisibility(View.GONE);

//                fragmentAbilitarVoltar(false);

//                String nomebanca = UsuarioSingleton.getUsuario().getNome_banca();
//                getSupportActionBar().setTitle(nomebanca);
            } else {
